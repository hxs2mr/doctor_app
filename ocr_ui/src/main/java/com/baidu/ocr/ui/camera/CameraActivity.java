...
public class CameraActivity extends Activity implements View.OnClickListener {
    ...
    private TextView zidon_shenfen_tv;
    private TextView shoudon_shenfen_tv;
    private LinearLayoutCompat back_linear;

    private TextView no_shenfen;
     String token;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        zidon_shenfen_tv = findViewById(R.id.zidon_shenfen_tv);
        shoudon_shenfen_tv = findViewById(R.id.shoudon_shenfen_tv);
        no_shenfen = findViewById(R.id.no_shenfen);
        ...
        zidon_shenfen_tv.setOnClickListener(this);
        shoudon_shenfen_tv.setOnClickListener(this);
        no_shenfen.setOnClickListener(this);
    ...
    public void onClick(View view) {
        int i = view.getId();
       if (i == R.id.shoudon_shenfen_tv) {
            Toast.makeText(getApplicationContext(),"手动获取",Toast.LENGTH_SHORT).show();
            shoudon_shenfen_tv.setBackgroundResource(R.drawable.carame_shape);
            zidon_shenfen_tv.setVisibility(View.GONE);
            contentType =  CONTENT_TYPE_GENERAL;
            initcaramer();
            contentType = CONTENT_TYPE_ID_CARD_FRONT;
            initcaramer();
            takePhotoBtn.setVisibility(View.VISIBLE);
        }else if(i == R.id.no_shenfen)
        {

            Toast.makeText(getApplicationContext(),"没有身份证",Toast.LENGTH_SHORT).show();
            Intent data = new Intent();
            data.putExtra("EDIT_SN","0");
            setResult(111, data);
            cameraView.stop();
            finish();
        }else if(i == R.id.back_linear)
       {
           finish();
       }
    }
