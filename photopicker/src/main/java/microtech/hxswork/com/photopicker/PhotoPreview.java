...
public class PhotoPreview {
  ...
  public final static String EXTRA_FLAGE  = "show_flage";
  ...
  public static class PhotoPreviewBuilder {
    ...
    public PhotoPreviewBuilder setFlage(int currentItem) {
      mPreviewOptionsBundle.putInt(EXTRA_FLAGE, currentItem);
      return this;
    }
