...
public class HeadImageView extends CircleImageView {
    ...
    private static int DEFAULT_AVATAR_RES_ID = R.drawable.start_head_url;
    ...
    public void loadBuddyAvatar1(String account,int falge) {
        final UserInfo userInfo = NimUIKit.getUserInfoProvider().getUserInfo(account);
        if(falge==0)
        {
            DEFAULT_AVATAR_RES_ID = R.drawable.start_head_url;
        }else {
            DEFAULT_AVATAR_RES_ID = R.drawable.deadpool;
        }
        doLoadImage(userInfo != null ? userInfo.getAvatar() : null, DEFAULT_AVATAR_RES_ID, DEFAULT_AVATAR_THUMB_SIZE);
    }
